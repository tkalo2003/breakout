...
public class Model 
{
    ...
    public int BAT_SIZE       = 30;     // Bat side
    ...
    public int HIT            = -1;      // Lives (penalty) for hitting the bottom of the screen
    public int BAT_BORDER_R   = 0;
    public int BAT_BORDER_L   = 0;
    ...
    {       
        ...
        for (int i=0; i < NUM_BRICKS; i++) {
            ...
            GameObj brick = new GameObj(BRICK_WIDTH*i, WALL_TOP, BRICK_WIDTH, BRICK_HEIGHT, Color.rgb(red, green, blue, .99)); //creates brick with random color
    ...
    public synchronized void updateGame()
    {
        ...
        { 
            ...
            addToLives( HIT );            // lives penalty for hitting the bottom of the screen
            if(lives == 0){
       ...
       // check whether ball has hit a (visible) brick
        ...
        x = bat.topX;  
        BAT_BORDER_R = Controller.BAT_BORDER_RC;
        BAT_BORDER_L = Controller.BAT_BORDER_LC;
        if (x >= width - B - BAT_SIZE) BAT_BORDER_R = 1;
        if (x <= 0 + B)BAT_BORDER_L = 1;
    }
